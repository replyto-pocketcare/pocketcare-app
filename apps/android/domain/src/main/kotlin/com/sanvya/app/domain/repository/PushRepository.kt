 ...
 * `push_subscriptions` and the dispatcher kept delivering to a device whose
 * owner had just said no. Web's `disablePush()` deletes the row; this is the
 * same contract.
 */
interface PushRepository {
     ...
     */
    suspend fun registerToken(token: String, platform: String, userId: String, lastSeenIso: String)
