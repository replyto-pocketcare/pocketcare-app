 ...
 * the already-ported care.pocket.domain.splitsmath.pairwiseEdges (P1.4a) and
 * care.pocket.domain.splitsinsights (also P1.4a), exactly mirroring
...
import care.pocket.domain.money.money
import care.pocket.domain.receipts.splitByWeights
import care.pocket.domain.receipts.splitEqual
import care.pocket.domain.splitsinsights.Contribution
import care.pocket.domain.splitsinsights.FriendEdge
import care.pocket.domain.splitsinsights.FriendInsight
import care.pocket.domain.splitsinsights.FriendSettlement
import care.pocket.domain.splitsinsights.FriendStats
import care.pocket.domain.splitsinsights.computeFriendStats
import care.pocket.domain.splitsinsights.pickFriendInsights
import care.pocket.domain.splitsmath.Party
import care.pocket.domain.splitsmath.pairwiseEdges
