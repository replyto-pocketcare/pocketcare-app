...
public enum PocketCareSchema {
    public static let tables: [TableDef] = [
        ...
        TableDef(
            name: "audience_group_members",
            viewName: "audience_group_members",
            columns: [
                ColumnDef(name: "group_id", type: .text),
                ColumnDef(name: "user_id", type: .text),
                ColumnDef(name: "joined_at", type: .text),
        ...
        TableDef(
            ...
            viewName: "audience_groups",
            columns: [
                ColumnDef(name: "name", type: .text),
                ColumnDef(name: "description", type: .text),
                ColumnDef(name: "sys_key", type: .text),
                ColumnDef(name: "kind", type: .text),
                ColumnDef(name: "rule", type: .text),
        ...
        TableDef(
            ...
            columns: [
                ...
                ColumnDef(name: "sip_amount", type: .integer),
                ColumnDef(name: "sip_start_date", type: .text),
                ColumnDef(name: "sip_day", type: .integer),
                ColumnDef(name: "total_invested", type: .integer),
                ColumnDef(name: "created_at", type: .text),
                ColumnDef(name: "updated_at", type: .text),
                ColumnDef(name: "deleted_at", type: .text),
            ],
        ...
        TableDef(
            ...
            columns: [
                ...
                ColumnDef(name: "kind", type: .text),
                ColumnDef(name: "title", type: .text),
                ColumnDef(name: "subtitle", type: .text),
                ColumnDef(name: "body", type: .text),
                ColumnDef(name: "image_url", type: .text),
                ColumnDef(name: "severity", type: .text),
        ...
        TableDef(
            name: "price_offers",
            viewName: "price_offers",
            columns: [
                ColumnDef(name: "tier", type: .text),
                ColumnDef(name: "cycle", type: .text),
                ColumnDef(name: "price", type: .integer),
                ColumnDef(name: "label", type: .text),
                ColumnDef(name: "starts_at", type: .text),
                ColumnDef(name: "ends_at", type: .text),
                ColumnDef(name: "segment_id", type: .text),
                ColumnDef(name: "active", type: .integer),
                ColumnDef(name: "created_at", type: .text),
                ColumnDef(name: "updated_at", type: .text),
            ],
        ...
        TableDef(
            ...
            columns: [
                ...
                ColumnDef(name: "source_table", type: .text),
                ColumnDef(name: "source_id", type: .text),
                ColumnDef(name: "created_at", type: .text),
                ColumnDef(name: "updated_at", type: .text),
                ColumnDef(name: "deleted_at", type: .text),
            ],
        ...
        TableDef(
            ...
            columns: [
                ...
                ColumnDef(name: "intent", type: .text),
                ColumnDef(name: "created_at", type: .text),
                ColumnDef(name: "updated_at", type: .text),
                ColumnDef(name: "deleted_at", type: .text),
            ],
