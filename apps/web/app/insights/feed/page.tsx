      ...
      <div className="fade-up" style={{ display: "grid", gap: 16, maxWidth: 560 }}>
        ...
        <div className="card" style={{ position: "relative", padding: 28, display: "grid", gap: 12, textAlign: "center", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", display: "grid", gap: 12 }}>
            ...
            <p className="muted">Weekly recaps, budget alerts and savings wins as bite-sized, animated cards — a Premium feature.</p>
  ...
  return (
    <div style={{ display: "grid", gap: 14 }}>
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        <h1 style={{ margin: 0 }}>Insight feed</h1>
        <Link href="/insights" className="muted" style={{ fontSize: 13 }}>Full insights →</Link>
      </div>
      <InsightFeed />
    </div>
  );
