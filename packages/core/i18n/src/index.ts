...
// The dashboard tile catalog. Added 2026-08-25 for the native port: web's
// TILE_CATALOG carries 14 hardcoded English titles and the Add-a-widget picker
// is hardcoded English throughout, so there was no key to port. Web still
// renders its own literals -- switching it over is Akhilesh's to schedule.
...
import reflectEn from "./locales/reflect/en.json";
import reflectHi from "./locales/reflect/hi.json";
import reflectNl from "./locales/reflect/nl.json";
...
import paymentsEn from "./locales/payments/en.json";
import paymentsHi from "./locales/payments/hi.json";
import paymentsNl from "./locales/payments/nl.json";

import receiptsEn from "./locales/receipts/en.json";
import receiptsHi from "./locales/receipts/hi.json";
import receiptsNl from "./locales/receipts/nl.json";
