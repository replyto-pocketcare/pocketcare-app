...
- [ ] **P0.5 [S] — Docs bootstrap.** Keep `PROJECT_REFERENCE.md` "Native mobile" section (layout, ADR, mobile change log, parity table) in sync with this plan. Verify `docs/mobile/TODO.md` matches this plan's tasks.
